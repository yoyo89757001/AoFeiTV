package com.example.aofeitv.dialog;
...
import com.example.aofeitv.beans.YongHuBean;
import com.example.aofeitv.ui.SheZhiActivity;
import com.example.aofeitv.ui.YiDongNianHuiActivity;
...
public class CaiDanDialog extends Dialog implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    private YiDongNianHuiActivity.MyAdapter adapter;
    ...
    public CaiDanDialog(Context context, int theme, MoShengRenBeanDao dao, YiDongNianHuiActivity.MyAdapter adapter, List<YongHuBean> moShengRenBean2List) {
        super(context, theme);
        this.context = context;
