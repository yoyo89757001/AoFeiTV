package com.example.aofeitv.tts;//package com.example.xiaojun.duomobanyanshi.tts;
//
...
//import com.example.xiaojun.duomobanyanshi.tts.listener.FileSaveListener;
//import com.example.xiaojun.duomobanyanshi.tts.util.FileUtil;
//
//
...
//        // 设置初始化参数
//        SpeechSynthesizerListener listener = new FileSaveListener(mainHandler, tmpDir); // 此处可以改为 含有您业务逻辑的SpeechSynthesizerListener的实现类
