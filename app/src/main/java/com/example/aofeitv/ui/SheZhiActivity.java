...
import com.example.aofeitv.dialog.XiuGaiXinXiDialog;
import com.example.aofeitv.dialog.YuLanDialog;
            ...
            case R.id.bt4:
                ...
                animatorSet4.addListener(new AnimatorListenerAdapter(){
                    @Override public void onAnimationEnd(Animator animation) {
                        ...
                        final XiuGaiXinXiDialog dialog=new XiuGaiXinXiDialog(SheZhiActivity.this);
                        if (baoCunBean.getYgHyc()==null){
                            dialog.setContents("设置员工欢迎词\n@代表名字#代表性别","欢迎@#");
                        }else {
                            dialog.setContents("设置员工欢迎词\n@代表名字#代表性别",baoCunBean.getYgHyc());
                        }
                        dialog.setOnQueRenListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                baoCunBean.setYgHyc(dialog.getContents());
                                baoCunBeanDao.update(baoCunBean);
                                baoCunBean=baoCunBeanDao.load(123456L);
                                dialog.dismiss();
                            }
            ...
            case R.id.bt5:
                ...
                animatorSet5.addListener(new AnimatorListenerAdapter(){
                    @Override public void onAnimationEnd(Animator animation) {
                        ...
                        final XiuGaiXinXiDialog dialog=new XiuGaiXinXiDialog(SheZhiActivity.this);
                        if (baoCunBean.getFkHyc()==null){
                            dialog.setContents("设置访客欢迎词\n@代表名字#代表性别","欢迎@#莅临参观指导");
                        }else {
                            dialog.setContents("设置访客欢迎词\n@代表名字#代表性别",baoCunBean.getFkHyc());
                        }
                        dialog.setOnQueRenListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                baoCunBean.setFkHyc(dialog.getContents());
                                baoCunBeanDao.update(baoCunBean);
                                baoCunBean=baoCunBeanDao.load(123456L);
                                dialog.dismiss();
                            }
...
//                        }
                        final XiuGaiXinXiDialog dialog=new XiuGaiXinXiDialog(SheZhiActivity.this);
                        if (baoCunBean.getWhHyc()==null){
                            dialog.setContents("设置维护人员欢迎词\n@代表名字#代表性别","欢迎@#莅临神舟机房");
                        }else {
                            dialog.setContents("设置维护人员欢迎词\n@代表名字#代表性别",baoCunBean.getWhHyc());
                        }
                        dialog.setOnQueRenListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                baoCunBean.setWhHyc(dialog.getContents());
                                baoCunBeanDao.update(baoCunBean);
                                baoCunBean=baoCunBeanDao.load(123456L);
                                dialog.dismiss();
                            }
