...
public class BaoCunBeanDao extends AbstractDao<BaoCunBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property YgHyc = new Property(9, String.class, "ygHyc", false, "YG_HYC");
        public final static Property FkHyc = new Property(10, String.class, "fkHyc", false, "FK_HYC");
        public final static Property WhHyc = new Property(11, String.class, "whHyc", false, "WH_HYC");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BAO_CUN_BEAN\" (" + //
                ...
                "\"YG_HYC\" TEXT," + // 9: ygHyc
                "\"FK_HYC\" TEXT," + // 10: fkHyc
                "\"WH_HYC\" TEXT);"); // 11: whHyc
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, BaoCunBean entity) {
        ...
        String ygHyc = entity.getYgHyc();
        if (ygHyc != null) {
            stmt.bindString(10, ygHyc);
        }
 
        String fkHyc = entity.getFkHyc();
        if (fkHyc != null) {
            stmt.bindString(11, fkHyc);
        }
 
        String whHyc = entity.getWhHyc();
        if (whHyc != null) {
            stmt.bindString(12, whHyc);
        }
    }
    ...
    public BaoCunBean readEntity(Cursor cursor, int offset) {
        BaoCunBean entity = new BaoCunBean( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // ygHyc
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // fkHyc
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // whHyc
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BaoCunBean entity, int offset) {
        ...
        entity.setYgHyc(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setFkHyc(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setWhHyc(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
