...
public class BaoCunBean {
    ...
    private String ygHyc;
    private String fkHyc;
    private String whHyc;
    @Generated(hash = 1084025279)
    public BaoCunBean(@NotNull Long id, String shipingIP, String zhujiDiZhi,
            ...
            String ygHyc, String fkHyc, String whHyc) {
        this.id = id;
    ...
    public String getYgHyc() {
        return this.ygHyc;
    }
    public void setYgHyc(String ygHyc) {
        this.ygHyc = ygHyc;
    }
    public String getFkHyc() {
        return this.fkHyc;
    }
    public void setFkHyc(String fkHyc) {
        this.fkHyc = fkHyc;
    }
    public String getWhHyc() {
        return this.whHyc;
    }
    public void setWhHyc(String whHyc) {
        this.whHyc = whHyc;
    }
